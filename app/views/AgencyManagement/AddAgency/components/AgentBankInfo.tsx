    ...
    <View style={styles.mainContainer}>
      ...
      >
        ...
        {props.agencyData?.gstApplicable === 1 ? (
          <View style={styles.inputWrap}>
            <InputField
              ...
              // require={true}
              placeholderText={props?.agencyData?.cp_type === 1 ? strings.gst : strings.compGst}
              maxLength={20}
              headingText={props?.agencyData?.cp_type === 1 ? strings.gst : strings.compGst}
              handleInputBtnPress={() => {}}
          ...
          >
            ...
            >
              <Text style={styles.headingText}>{props?.agencyData?.cp_type === 1 ? strings.DeclarLttr : strings.declrLttrCom}</Text>
              {/* <RequiredStart /> */}
            </View>
            <View style={{ flex: 0.5 }}>
              <TouchableOpacity
        ...
        >
          ...
          >
            <Text style={styles.headingText}>{props?.agencyData?.cp_type === 1 ? strings.CpreraCertificate : strings.compReraCertificate}</Text>
            {/* <RequiredStart /> */}
          </View>
          <View style={{ flex: 0.5 }}>
            <TouchableOpacity
        ...
        {props?.agencyData?.cp_type === 2 ? <View
          style={[
            styles.inputWrap,
            { flexDirection: "row", alignItems: "center" },
          ]}
