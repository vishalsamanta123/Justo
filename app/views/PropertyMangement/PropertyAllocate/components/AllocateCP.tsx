...
import { BLACK_COLOR, GRAY_COLOR, GREEN_COLOR, PRIMARY_THEME_COLOR, RED_COLOR, ROLE_IDS, WHITE_COLOR } from '../../../../components/utilities/constant';
...
const AllocateCPView = (props: any) => {
    ...
    return (
        <View style={styles.mainContainer}>
                        ...
                        ListEmptyComponent={() => {
                            return (
                                <Text style={[styles.noSelectedTxt, {textAlign: 'center'}]}>{
                                    userData?.data?.role_title === "Sourcing TL" ? 'No SM Found' :
                                        userData?.data?.role_title === "Closing TL" ? 'No CM Found' :
                                            strings.noCpFound}</Text>
                            )
                        }}
                    /> : null
                }
            ...
            />
            {userData?.data?.role_id !== ROLE_IDS.sourcingmanager_id ? <AddTargetModal
