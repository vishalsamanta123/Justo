import { View, Text, StatusBar, ScrollView, Image, FlatList, TouchableOpacity, Switch } from "react-native";
        ...
        />
          <ScrollView style={styles.dashboardScroll} bounces={false}>
            ...
            <View style={styles.thirdPortion}>
              <View style={styles.thirdPortioncardView}>
                <View style={styles.thirdPortionCardTextView}>
                  <Text style={styles.thirdPortionCardText} numberOfLines={2}>Today Site Visit</Text>
                </View>
                <View style={styles.numberView}>
              ...
              <View style={styles.thirdPortioncardView}>
                <View style={styles.thirdPortionCardTextView}>
                  <Text style={styles.thirdPortionCardText}>Today Closed Visit</Text>
                </View>
                <View style={styles.numberView}>
                  <Text style={styles.thirdPortionNumberText}>1000/250</Text>
                </View>
            ...
            <View style={styles.bottomSection}>
              ...
              <TouchableOpacity style={styles.headingView}>
                <Text style={[styles.headingText, styles.knowMoreText]}>Know More</Text>
              </TouchableOpacity>
            </View>
          </ScrollView>
      </View>
