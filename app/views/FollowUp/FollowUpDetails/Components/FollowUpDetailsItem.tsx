...
import { DATE_TIME_FORMAT } from 'app/components/utilities/constant'
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.topDetailsView}>
                <View style={styles.topTxtView}>
                    ...
                    <Text style={styles.topTxt}>{props?.data?.lead_score ? props?.data?.lead_score : 0}</Text>
                </View>
            </View>
            {props?.data?.property &&
            ...
            <View style={styles.Txtview}>
                ...
                <View><Text>:</Text></View>
                <View style={styles.nameContainer}>
                    <Text style={styles.nameTxt}>{props?.data?.followup_date ? moment(props?.data?.followup_date).format(DATE_TIME_FORMAT) : strings.notfount}</Text>
                </View>
            </View>
            <View style={styles.Txtview}>
                <View style={styles.projectContainer}>
                ...
                <View><Text>:</Text></View>
                <View style={styles.nameContainer}>
                    <Text style={styles.nameTxt}>{props?.data?.created_name ? props?.data?.created_name : strings.notfount}</Text>
                </View>
            </View>
            <View style={styles.Txtview}>
                <View style={styles.projectContainer}>
            ...
            <>
                {props?.data?.configuration ||
                    props?.data?.areain_sqlft ||
                    props?.data?.min_budget && props?.data?.max_budget ||
                    props?.data?.funding_type || props?.data?.purpose ?
                ...
                {props?.data?.configuration &&
                    <View style={styles.Txtview}>
                        ...
                        <View><Text>:</Text></View>
                        <View style={styles.nameContainer}>
                            <Text style={styles.nameTxt}>{props?.data?.configuration || props?.data?.configuration === null ? props?.data?.configuration : strings.notfount}</Text>
                        </View>
                    </View>
                }
                {props?.data?.areain_sqlft &&
